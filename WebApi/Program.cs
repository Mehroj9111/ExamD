...
try
{
    using (var scope = app.Services.CreateScope())
    {
        ...
        //-------------------------------------------------------
        var actor = services.GetRequiredService<DataContext>();
        var category = services.GetRequiredService<DataContext>();
        var movie = services.GetRequiredService<DataContext>();
        //--------------------------------------------------------
        ...
        await DefaultActor.SeedAsync(actor);
        await DefaultCategory.SeedAsync(category);
        await DefaultMovie.SeedAsync(movie);
